<template>
  <div class="page assets-page">
    ...
    <div class="toolbar">
      ...
      <el-cascader v-model="categoryPath" class="dl-cascader" clearable :options="categories" :props="categoryProps" placeholder="全部分类" @change="applyFilters" />
      ...
      <button class="secondary-button search-button" @click="applyFilters">搜索</button>
    </div>
